...
import { dpr_brchure } from '../../assets'; // Importing brochure file from assets
...
const ModalForm: React.FC<ModalFormProps> = ({ open, handleClose }) => {
  ...
  const downloadBrochure = () => {
    ...
    link.download = 'DPR_Brochure.pdf';
  ...
  return (
    <>
      ...
      >
        ...
        <Typography variant="body2" sx={{ textAlign: 'left', padding: theme.spacing(2) }}>
          Complete the form below to receive your brochure instantly.
        </Typography>
